...
<header class="sticky top-0 bg-white shadow">
    <div class="container flex flex-col sm:flex-row justify-between items-center mx-auto py-4 px-8">
        ...
        <div class="flex mt-4 sm:mt-0">
            <a class="px-4" href="#features">Fonctionalites</a>
            <a class="px-4" href="#services">Pourquoi</a>
            <a class="px-4" href="#stats">Retour</a>
            <a class="px-4" href="#optimisation">optimisation</a>
        </div>
        <div class="hidden md:block">
           <router-link to="/login">
            <button type="button"
                class=" py-3 px-8 text-sm bg-teal-500 hover:bg-teal-600 rounded text-white ">Log In
            </button>
           </router-link>
        </div>
    </div>
...
<main class="text-gray-900">
    ...
    <section class="pt-20 md:pt-40">
        <div class="container mx-auto px-8 lg:flex">
            <div class="text-center lg:text-left lg:w-1/2">
                <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">Évaluez vos enseignants en toute transparence !</h1>
                <p class="text-xl lg:text-xl mt-6 font-light">Vous avez toujours voulu donner votre avis sur la qualité des cours dispensés par vos enseignants ? Nous vous offre cette opportunité !
                </p>
                <p class="mt-8 md:mt-12">
                   <router-link to="/register">
                    <button type="button"
                    class=" py-4 px-12 bg-teal-500 hover:bg-teal-600 rounded text-white">Commencer
                </button>
                   </router-link>
                </p>
    ...
    <section id="features" class="py-20 lg:pb-40 lg:pt-48">
        <div class="container mx-auto text-center">
            <h2 class="text-3xl lg:text-5xl font-semibold">fonctionnalités principales</h2>
            <div class="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div class="flex-1 px-3">
                    <div class="p-12 rounded-lg border border-solid border-gray-200 mb-8"
                        ...
                        <p class="font-semibold text-xl">Interagir dans les comptes des professeurs

                        </p>
                        <p class="mt-4">Grâce à notre plateforme, les étudiants peuvent facilement consulter les
                             profils des professeurs et participer à des discussions sur les cours dispensés.
                              Chaque professeur a son propre compte où les étudiants peuvent partager leurs avis, 
                            poser des questions ou échanger des retours d’expérience sur les cours.
                        </p>
                    </div>
                </div>
                <div class="flex-1 px-3">
                    <div class="p-12 rounded-lg border border-solid border-gray-200 mb-8"
                        style="box-shadow:0 10px 28px rgba(0,0,0,.08)">
                        <p class="font-semibold text-xl">Noter un professeur
                        </p>
                        <p class="mt-4">Les étudiants peuvent attribuer des notes aux professeurs en fonction de
                             divers critères tels que la pédagogie, la disponibilité, l’organisation du cours, 
                             et bien plus encore. Cela permet aux autres étudiants de faire un choix éclairé et
                              d’encourager les enseignants à améliorer leur méthode d'enseignement.
                        </p>
                    </div>
                </div>
                <div class="flex-1 px-3">
                    <div class="p-12 rounded-lg border border-solid border-gray-200 mb-8"
                        style="box-shadow:0 10px 28px rgba(0,0,0,.08)">
                        <p class="font-semibold text-xl">Recevoir des réponses de l'administrateur

                        </p>
                        <p class="mt-4">L’application permet également aux étudiants de poser des questions ou de soumettre
                             des préoccupations concernant les cours ou les professeurs. Les administrateurs répondent rapidement
                              pour garantir une gestion efficace
                             des problèmes ou des suggestions, et maintenir un environnement d'apprentissage optimal.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-16 items-center flex flex-col lg:flex-row">
            <div class="lg:w-1/2">
                <div class="lg:pr-32 xl:pr-48">
                    <h3 class="text-3xl font-semibold leading-tight">Pourquoi choisir cette application ?</h3>
                    <p class="mt-8 text-md font-light leading-relaxed">Dans un monde où l’éducation évolue constamment, 
                        il est essentiel d’avoir un outil fiable pour évaluer la qualité des enseignements.
                         <b>Sugession</b> offre une plateforme innovante qui permet aux étudiants de noter et
                          de partager leurs expériences sur les cours et les professeurs, contribuant ainsi à améliorer 
    ...
    <section class="py-20" id="stats">
        <div class="container mx-auto px-16 items-center flex flex-col lg:flex-row">
            <div class="lg:w-1/2">
                <div class="lg:pl-32 xl:pl-48">
                    <h3 class="text-3xl font-semibold leading-tight">Retours des Étudiants
                        </h3>
                    <p class="mt-8 text-md font-light leading-relaxed">Affichage des avis et témoignages d'autres étudiants, pour encourager la participation et donner une idée de l'expérience utilisateur.
                    </p>
                </div>
            </div>
    ...
    <section class="py-20" id="optimisation">
        <div class="container mx-auto px-16 items-center flex flex-col lg:flex-row">
            <div class="lg:w-1/2">
                <div class="lg:pr-32 xl:pr-48">
                    <h3 class="text-3xl font-semibold leading-tight">Rechercher la performance et l'optimisation
                    </h3>
                    <p class="mt-8 text-md font-light leading-relaxed">Notre application vise avant tout la performance avec l'optimisation des 
                        requetes pour l'envoies des messages et ausi une interface fluide et interactive.
    ...
    <section class="container mx-auto my-20 py-24 bg-gray-200 rounded-lg text-center">
        <h3 class="text-5xl font-semibold">Rejoignez-nous dès aujourd'hui !</h3>
        <p class="mt-8 text-xl font-light">Un appel à l'action clair pour inciter les utilisateurs à s'inscrire ou commencer à utiliser l'application.
        </p>
        <p class="mt-8">
           <router-link to="register">
            <button type="button"
                class=" py-5 px-16 text-lg bg-teal-500 hover:bg-teal-600 rounded text-white ">Commencer maintenant
            </button>
           </router-link>
        </p>
    </section>
...
<footer class="container mx-auto py-16 px-3 mt-48 mb-8 text-gray-800">
    <div class="flex -mx-3">
        <div class="flex-1 px-3">
            <h2 class="text-lg font-semibold">A propos de nous</h2>
            <p class="mt-5">Nous sommes apprenant en Genie logiciel chez Isetag
            </p>
        </div>
        <div class="flex-1 px-3">
            <h2 class="text-lg font-semibold">Liens Importants</h2>
            <ul class="mt-4 leading-loose">
                <li><a href="https://codebushi.com">Terms &amp; Conditions</a></li>
                <li><a href="https://codebushi.com">Politique Privee</a></li>
            </ul>
        </div>
        <div class="flex-1 px-3">
            <h2 class="text-lg font-semibold">Reseaux Sociaux</h2>
            <ul class="mt-4 leading-loose">
