      ...
      <div class="space-y-4 bg-[red-400] w-[90%] lg:w-[60%] h-auto text-[16px]">
        ...
        <div class="space-y-2">
          ...
          <div class="space-y-1 w-full h-auto">
            ...
            <input
              type="text"
              v-model="subname" placeholder="Enter Subname"
              class="px-4 rounded-md w-full h-12 font-semibold placeholder:font-semibold text-black placeholder:text-gray-800 focus:outline-none"
            />
          </div>
          <div class="space-y-1 w-full h-auto">
          ...
          <div class="space-y-1 w-full h-auto">
            ...
            <div class="flex bg-white rounded-md w-full text-black focus:outline-none">
              <input
                :type="value == false ? 'password' : 'text'"
              ...
              <div class="flex justify-center items-center w-1/12">
                <div @click="value = !value" class="cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
        ...
        <div class="flex space-x-2 w-full">
          <p class="font-extralight">I have a Account?</p>
          <router-link to="login" class="font-semibold text-white">Sign In</router-link>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  sendMail(){
    ...
    verifyCode(){
      ...
      let datas = new FormData();      
      datas.append("email", this.email);
      datas.append("code", this.valueInt);
